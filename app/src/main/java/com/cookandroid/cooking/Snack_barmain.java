...
public class Snack_barmain extends AppCompatActivity {

    private static final String TAG = "Snack_barmain";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snack_barmain);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                case R.id.menu_home:
                    Intent intent = new Intent(Snack_barmain.this, MainActivity.class);
                    startActivity(intent);
                    finish(); // 현재 액티비티 종료
                    return true;

                case R.id.menu_map:
                    Intent intent2 = new Intent(Snack_barmain.this, MapsActivity.class);
                    startActivity(intent2);
                    finish(); // 현재 액티비티 종료
                    return true;
                case R.id.menu_profile:
                    Intent intent3 = new Intent(Snack_barmain.this, profile.class);
        ...
        // 게시글 목록을 표시할 레이아웃 찾기
        Snack_barMainList = findViewById(R.id.snack_barmian_list);
        ...
        addListIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Snack_barmain.this, Add_list_snack_bar.class);
                startActivity(intent);
            }
        });
    ...
    private void addRecipeToLayout(final Recipe recipe, final String currentDate, String userId) {
        ...
        TextView hostIdTextView = recipeItemView.findViewById(R.id.snack_barlist_hostid);
        hostIdTextView.setText(getUserEmail(recipe.getUserId()));

        // 이미지를 표시하는 ImageView를 찾아옴
        ImageView imageView = recipeItemView.findViewById(R.id.snack_barlist_img);
        ...
        Snack_barMainList.addView(recipeItemView);

...
public class Add_list_salad extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Find views
        imageView = findViewById(R.id.add_list_salad_img);
        titleEditText = findViewById(R.id.add_list_salad_tittle);
        recipeEditText = findViewById(R.id.add_list_salad_recipe);
    ...
    private void addRecipeToLayout(Recipe recipe, String recipeId) {
        ...
        SaladMainList.addView(recipeLayout);
    }
        ...
        storageReference.putFile(imageUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(Add_list_salad.this, "이미지 업로드에 실패했습니다", Toast.LENGTH_SHORT).show();
                    }
                });
    }
